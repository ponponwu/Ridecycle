...
const MakeOfferDialog = ({ bicycleTitle, bicycleId = '1', currentUser }: MakeOfferDialogProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="w-full bg-marketplace-orange hover:bg-orange-600" onClick={handleTriggerClick}>
