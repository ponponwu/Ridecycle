            ...
            <div className="container flex items-center justify-between h-20 px-4 mx-auto sm:px-6 lg:px-8">
                ...
                <Link to="/" className="flex items-center group">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xl font-bold text-gray-900 leading-tight">自行車交易</span>
                ...
                <div className="hidden lg:flex items-center space-x-3">
                    <Link to="/search">
                        <Button
                            variant="outline"
                            size="icon"
                            className="rounded-xl border-emerald-200 hover:bg-emerald-50 hover:border-emerald-300 transition-colors"
                        >
                    ...
                    <div className="container px-4 py-6 mx-auto">
                        <nav className="flex flex-col space-y-2">
                            ...
                            >
                                ...
                                <span className="text-gray-700 font-medium">瀏覽自行車</span>
                            </Link>
                            ...
                            >
                                ...
                                <span className="text-gray-700 font-medium">我的收藏</span>
                            </Link>
                            ...
                            >
                                ...
                                <span className="text-gray-700 font-medium">消息中心</span>
                            </Link>
                            ...
                            {currentUser && (
                                ...
                                >
                                    ...
                                    <span className="text-gray-700 font-medium">我的訂單</span>
                                </Link>
                            )}
                            ...
                            {currentUser ? (
                                <>
                                    ...
                                    >
                                        ...
                                        <span className="text-gray-700 font-medium">個人中心</span>
                                    </Link>
                                    ...
                                    {currentUser.admin && (
                                        ...
                                        >
                                            ...
                                            <span className="text-gray-700 font-medium">管理員</span>
                                        </Link>
                                    )}
                                    ...
                                    >
                                        ...
                                        <span className="text-gray-700 font-medium">登出</span>
                                    </button>
                                </>
                            ) : (
                                <Link
                                ...
                                >
                                    <User className="w-5 h-5 mr-3 text-emerald-600" />
                                    <span className="text-gray-700 font-medium">登入</span>
                                </Link>
                            )}
